...
export class Backend implements backendInterface {
    ...
    async getNominationCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getNominationCount();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getNominations(): Promise<Array<Nomination>> {
        if (this.processError) {
            try {
                const result = await this.actor.getNominations();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitNomination(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitNomination(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
